# 👋 Hey, I'm Caio / 👋 Fala, eu sou o Caio

Cybersecurity student exploring the offensive side of security.
I break labs, document everything, focus on understanding how small misconfigurations lead to full compromise and at free time i develop something.
Learning every day:
- Enumeration
- Web exploitation
...
Quebro labs, documento tudo, foco em entender como pequenas más configurações podem levar à compromissão total de um sistema e no tempo livre desenvolvo algo.
...
![TryHackMe](https://img.shields.io/badge/-TryHackMe-black?style=flat-square&logo=tryhackme)
